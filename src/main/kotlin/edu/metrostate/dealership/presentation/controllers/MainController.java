...
import edu.metrostate.dealership.Main;
...
public class MainController {
    ...
    private final Logger logger = Logger.Companion.getLogger();
    ...
    private void onAddVehicle() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/metrostate/dealership/add-vehicle.fxml"));
            Parent root = loader.load();

            Scene scene = new Scene(root);
            Main.Companion.setTheme(scene, getClass()); // Apply our theme
...
public String fixID(String vehicleID, String dealershipId) {
    ...
    private void setupVehiclesTable() {
        ...
        isRentedColumn.setCellValueFactory(cellData ->
                new SimpleStringProperty(cellData.getValue().isRentedAsString()));
